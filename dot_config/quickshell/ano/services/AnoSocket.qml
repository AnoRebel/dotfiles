...
// AnoSocket: Reconnecting socket wrapper for IPC communication.
// Used by NiriService for bidirectional Niri compositor IPC.
//
// Features:
...
//
// Extension point: A C++ plugin could replace this with a native
// socket implementation for better performance/reliability.
Item {
    id: root
